...
NN_metrics <- function(gene_KNN,peak_KNN,allProb,uniqSamples,delimiter='_',removeItself=TRUE,mType='NxN',k.param = 100){
    ...
    metrics_df <- data.frame('sample'=character(),'sKNN'=integer(),'lsKLD'=numeric(),stringsAsFactors=FALSE)
